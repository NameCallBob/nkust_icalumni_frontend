...
const TermsAndConditionsPage = () => {
  ...
  return (
    <div className="terms-container">
      {/* 頂部標題 */}
      <div className="terms-header bg-base-200 py-4 shadow-sm">
        <div className="container mx-auto px-4">
          <h1 className="text-center font-bold">智慧商務系友會網站使用條款</h1>
      ...
      {isMobile && (
        <div className="container mx-auto px-4 mt-3">
          <button
            className="btn btn-outline btn-primary w-full flex justify-between items-center"
      ...
      <div className="container mx-auto px-4 mt-4">
        <div className="flex flex-wrap -mx-2">
          {/* 側邊導航欄 */}
          <div className={`w-full lg:w-1/4 px-2 terms-sidebar ${isMobile ? (showSidebar ? 'show-mobile' : 'hide-mobile') : ''}`}>
            <div className="sidebar-wrapper p-3 rounded shadow-sm bg-base-200">
              <h5 className="font-bold mb-3">目錄</h5>
              <ul className="flex flex-col">
                {sections.map((section) => (
                  <li key={section.id} className="mb-2">
                    <a
                      className={`block ${activeSection === section.id ? 'active bg-' + section.color + ' text-white' : 'text-base-content'} rounded p-2`}
                      href={`#${section.id}`}
                      onClick={(e) => {
                        e.preventDefault();
            ...
            <div className="terms-content bg-white p-4 rounded shadow-sm">
              ...
              <section id="section1" className="mb-5">
                <div className="section-header bg-primary text-white p-3 rounded">
                  <h2 className="text-xl mb-0 font-bold">一般規定</h2>
                </div>
                <div className="section-body p-3">
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">一、總則</h3>
                  ...
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">十一、準據法與管轄法院</h3>
                    <div className="pl-3 content-block">
                  ...
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">十二、其他條款</h3>
                    <div className="pl-3 content-block">
              ...
              <section id="section2" className="mb-5">
                <div className="section-header bg-success text-white p-3 rounded">
                  <h2 className="text-xl mb-0 font-bold">帳號管理與內容發布</h2>
                </div>
                <div className="section-body p-3">
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">二、使用者資格與帳號管理</h3>
                    <div className="pl-3 content-block">
                  ...
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">三、內容發布與限制</h3>
                    <div className="pl-3 content-block">
              ...
              <section id="section3" className="mb-5">
                <div className="section-header bg-info text-white p-3 rounded">
                  <h2 className="text-xl mb-0 font-bold">商業活動</h2>
                </div>
                <div className="section-body p-3">
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">四、公司介紹、產品資訊與招募發布</h3>
                    <div className="pl-3 content-block">
                  ...
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">八、系友媒合與招募之責任歸屬</h3>
                    <div className="pl-3 content-block">
              ...
              <section id="section4" className="mb-5">
                <div className="section-header bg-warning text-dark p-3 rounded">
                  <h2 className="text-xl mb-0 font-bold">法律權益</h2>
                </div>
                <div className="section-body p-3">
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">五、智慧財產權</h3>
                    <div className="pl-3 content-block">
                  ...
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">六、隱私保護</h3>
                    <div className="pl-3 content-block">
                  ...
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">七、責任限制</h3>
                    <div className="pl-3 content-block">
              ...
              <section id="section5" className="mb-5">
                <div className="section-header bg-danger text-white p-3 rounded">
                  <h2 className="text-xl mb-0 font-bold">管理與終止</h2>
                </div>
                <div className="section-body p-3">
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">九、違規處理</h3>
                    <div className="pl-3 content-block">
                  ...
                  <article className="mb-4">
                    <h3 className="text-lg font-bold">十、終止服務</h3>
                    <div className="pl-3 content-block">
