...
const TermsAndConditionsPage = () => {
  ...
  // ── presentation helpers（純樣式，無邏輯） ──
  const ArticleBlock = ({ heading, children }) => (
    <article className="mb-8 last:mb-0">
      <h3 className="font-serif text-lg sm:text-xl font-bold text-primary flex items-center gap-3">
        <span className="inline-block h-5 w-1 rounded-full bg-secondary" />
        {heading}
      </h3>
      <div className="mt-3 pl-4 space-y-3 text-[15px] leading-7 text-base-content/80 border-l border-base-200">
        {children}
      </div>
    </article>
  );

  const NoticeList = ({ children }) => (
    <ul className="my-3 space-y-2 rounded-xl bg-primary/5 border border-primary/10 p-4 text-base-content/80">
      {children}
    </ul>
  );
  ...
  return (
    <div className="min-h-screen bg-base-200">
      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e3a8a] to-[#0f172a] text-white">
        <div className="absolute inset-0 opacity-[0.08] bg-[radial-gradient(circle_at_20%_20%,white,transparent_40%),radial-gradient(circle_at_80%_60%,white,transparent_35%)]" />
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 py-14 sm:py-20 text-center">
          ...
          <div className="mx-auto mt-5 h-1 w-20 rounded-full bg-gradient-to-r from-secondary to-white/60" />
      ...
      {isMobile && (
        <div className="mx-auto max-w-6xl px-4 sm:px-6 mt-5">
          <button
            className="w-full flex items-center justify-between rounded-xl border border-primary/20 bg-white px-4 py-3 font-semibold text-primary shadow-sm"
            onClick={toggleSidebar}
          >
            <span>章節導覽</span>
            {showSidebar ? <BsChevronUp /> : <BsChevronDown />}
          </button>
        </div>
      )}
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          {/* 側邊導航欄 */}
          <aside
            className={`lg:col-span-4 xl:col-span-3 ${isMobile && !showSidebar ? 'hidden' : 'block'}`}
          >
            <div className="lg:sticky lg:top-24">
              <Card padding="md">
                <h5 className="font-serif text-base font-bold text-primary mb-4 flex items-center gap-2">
          ...
          <main className="lg:col-span-8 xl:col-span-9 space-y-6">
            ...
            <section id="section1" className="scroll-mt-24">
              <Card padding="none" hover={false}>
                <div className="flex items-center gap-3 rounded-t-2xl bg-gradient-to-r from-[#0f172a] to-[#1e3a8a] px-5 sm:px-7 py-5 text-white">
                  <Badge variant="secondary" soft={false}>01</Badge>
                  <h2 className="font-serif text-xl sm:text-2xl font-bold">一般規定</h2>
                </div>
                <div className="px-5 sm:px-7 py-6 sm:py-8">
                  <ArticleBlock heading="一、總則">
            ...
            <section id="section2" className="scroll-mt-24">
              <Card padding="none" hover={false}>
                <div className="flex items-center gap-3 rounded-t-2xl bg-gradient-to-r from-[#0f172a] to-[#1e3a8a] px-5 sm:px-7 py-5 text-white">
                  <Badge variant="secondary" soft={false}>02</Badge>
                  <h2 className="font-serif text-xl sm:text-2xl font-bold">帳號管理與內容發布</h2>
                </div>
                <div className="px-5 sm:px-7 py-6 sm:py-8">
                  <ArticleBlock heading="二、使用者資格與帳號管理">
                  ...
                  <ArticleBlock heading="三、內容發布與限制">
            ...
            <section id="section3" className="scroll-mt-24">
              <Card padding="none" hover={false}>
                <div className="flex items-center gap-3 rounded-t-2xl bg-gradient-to-r from-[#0f172a] to-[#1e3a8a] px-5 sm:px-7 py-5 text-white">
                  <Badge variant="secondary" soft={false}>03</Badge>
                  <h2 className="font-serif text-xl sm:text-2xl font-bold">商業活動</h2>
                </div>
                <div className="px-5 sm:px-7 py-6 sm:py-8">
                  <ArticleBlock heading="四、公司介紹、產品資訊與招募發布">
                  ...
                  <ArticleBlock heading="八、系友媒合與招募之責任歸屬">
            ...
            <section id="section4" className="scroll-mt-24">
              <Card padding="none" hover={false}>
                <div className="flex items-center gap-3 rounded-t-2xl bg-gradient-to-r from-[#0f172a] to-[#1e3a8a] px-5 sm:px-7 py-5 text-white">
                  <Badge variant="secondary" soft={false}>04</Badge>
                  <h2 className="font-serif text-xl sm:text-2xl font-bold">法律權益</h2>
                </div>
                <div className="px-5 sm:px-7 py-6 sm:py-8">
                  <ArticleBlock heading="五、智慧財產權">
            ...
            <section id="section5" className="scroll-mt-24">
              <Card padding="none" hover={false}>
                <div className="flex items-center gap-3 rounded-t-2xl bg-gradient-to-r from-[#0f172a] to-[#1e3a8a] px-5 sm:px-7 py-5 text-white">
                  <Badge variant="secondary" soft={false}>05</Badge>
                  <h2 className="font-serif text-xl sm:text-2xl font-bold">管理與終止</h2>
                </div>
                <div className="px-5 sm:px-7 py-6 sm:py-8">
                  <ArticleBlock heading="九、違規處理">
      ...
      {/* 返回頂部按鈕 */}
      <button
        className="fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-white shadow-lg shadow-primary/30 transition-transform hover:-translate-y-0.5 hover:bg-[#0f172a]"
        onClick={scrollToTop}
        title="返回頂部"
      >
